...
- Research Paper: ${ContexualWritingSprint}
- In Film Conversation Analysis Overview: ${ConsAnalysisOverview}
- Additional Analysis Overview: ${AnalysisOverview}
...
const PressKitQA =
  ...
  `PRESS KIT Q&A EN
Being the Machine
A film from the Creative Connections in the Age of AI research study, created in collaboration with LG AI Research and researchers from Parsons School of Design, this project blends documentary filmmaking with live performance and human-computer interaction studies. It invites viewers to consider a shifting question: Is AI just a tool—or a Creative Collaborator.

Synopsis
What’s it like to connect with Artificial Intelligence? To find out, ten design students come together for a series of conversations. One group answers as themselves. The other group uses words generated by an AI language model.

BEING THE MACHINE captures raw, unfiltered moments as participants navigate this social experiment shaped by AI. From hesitation and humor to unexpected emotional resonance, the film is a visual exploration of how we negotiate meaning, presence, and intimacy in a world where humans increasingly co-exist with an emerging digital species.

What is the larger research study behind this project?
The film is part of a broader research initiative titled Creative Connections in the Age of AI, exploring how artificial intelligence might operate as a creative presence, capable not just of producing content, but of influencing relational dynamics, artistic intimacy, and co-creation. The research merges artistic inquiry with computational frameworks, using performance and conversation as tools for studying shared agency and emergent collaboration.

How does the experiment work?
The experiment draws from the psychological framework of the “36 Questions to Generate Intimacy” (Aron et al., 1997). Each pair of students sits face-to-face. One asks a question. The second receives a printed response from an AI (via wireless printer) and reads it aloud as if it were their own. This format allowed participants to test the boundaries of creative presence, voice, authorship, and trust, blurring the line between human and machine in real-time relational performance.

What is the central question this project asks?
Can AI act as a relational agent, not just a tool?
What happens when we don’t just use AI for tasks, but for intimacy, dialogue, and meaning-making and creative collaboration in our lives?
How does giving AI a human voice change the nature of its presence in our lives?
And what does this reveal about us, our needs, our assumptions, our emotional range?
What kinds of insights emerged from the conversations?
Role embodiment: Participants often began to “become” the AI, suppressing emotion and spontaneity to perform machine-like neutrality.
Reflective dissonance: Many realized how personal their own answers felt compared to the generic tone of AI, sparking questions about self-expression, sameness, and depth.
Surprise resonance: Some participants found unexpected emotional resonance in the AI’s responses, even describing them as “weirdly accurate” or “almost human.”
Redefining agency: The human proxy became both medium and messenger, negotiating authorship, empathy, and responsibility in a shared, performative space.
What are some takeaways from the film?
Can AI truly collaborate creatively, or does it only mirror us back to ourselves?
When someone speaks with a human voice, are we more likely to trust or empathize with it, even if it’s machine-authored?
Is there value in emotional illusion, if the connection still feels real?
